...
"<td height=\"25\" align=\"right\">密码:</td><td><input type=\"password\" name=\"m_pwd\" style=\"width:150px\"/><span class=\"red\">*密码由6-14位字母数字和'_'组成</span></td>".
  ...
  "</tr>".
  "<tr>".
	 	"<td height=\"25\" align=\"right\">验证码:</td><td><input type=\"text\" name=\"validate\" id=id=\"vdcode\" style=\"width:150px;text-transform:uppercase;\"/><img id=\"vdimgck\" src=\"include\/vdimgck.php\" alt=\"看不清？点击更换\" align=\"absmiddle\" style=\"cursor:pointer\" onClick=\this.src=this.src+'?get=' + new Date()\"/><span class=\"red\">*验证码</span></td>".
  "</tr>". 
  "<tr>".
