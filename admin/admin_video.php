...
elseif($action=="save")
{
	...
	$v_tags = cn_substrR(strtolower(addslashes($v_tags)),255);
	...
	$v_nickname = cn_substrR($v_nickname,200);
	$v_nickname = str_replace('\'', ' ', $v_nickname);
