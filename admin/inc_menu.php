...
$menu=array (
	...
	'content'=>array (
		...
		10=>"<a target='I2' href='admin_video.php?v_recycled=ok'>数据回收站</a>",
		11=>"<a target='I2' href='admin_topic.php'>专题管理</a>",
		12=>"<a target='I2' href='admin_comment.php?action=reporterror'>报错数据</a>",
		13=>"<a target='I2' href='admin_pseudo.php'>伪原创设置</a>",
		14=>"",
		15=>"<a target='I2' href='admin_type_news.php'>新闻分类</a>",
		16=>"<a target='I2' href='admin_news.php'>新闻管理</a>",
		17=>"<a target='I2' href='admin_news.php?action=add'>新闻添加</a>",
		18=>"<a target='I2' href='admin_news.php?n_recycled=ok'>新闻回收站</a>",
	...
	'gathersoft'=>array (
		...
		0=>"采集",
		1=>"<a target='I2' href='api.php'>资源库</a>",
		2=>"",
		...
		15=>"<a target='I2' href='admin_collect_news.php?action=importrule'>导入新闻采集规则</a>",
	...
	'webhelper'=>array (
		...
		2=>"<a target='I2' href='admin_comment.php'>视频评论管理</a>",
		3=>"<a target='I2' href='admin_comment_news.php'>新闻评论管理</a>",
		4=>"<a target='I2' href='admin_expand.php'>幻灯片管理</a>",
		5=>"",
		6=>"<a target='I2' href='admin_ads.php?action=main'>广告管理</a>",
		7=>"<a target='I2' href='admin_ads.php?action=add'>添加广告</a>",
		8=>"",
		9=>"<a target='I2' href='admin_link.php'>友情链接</a>",
	),
	'system'=>array (
